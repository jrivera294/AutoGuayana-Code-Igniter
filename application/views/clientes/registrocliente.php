          ...
          <form role="form" action='<?= base_url();?>index.php/clientes/save' method="post">
			...
			<div class="row">
				...
				<div class="col-xs-12 col-sm-6 col-md-6">
					...
					<div class="form-group">
                        ...
                        <input type="radio" name="sexo" id="radios-0" value="M" checked="checked">
                        Masculino
                        </label>
                        <label class="radio" for="radios-1">
                        <input type="radio" name="sexo" id="radios-1" value="F">
                        Femenino
                        </label>
					</div>
				</div>
			...
			<div class="row">
				...
				<div class="col-xs-12 col-sm-6 col-md-6">
					...
					<div class="form-group">
                        <input type="text" name="empresa" id="empresa" class="form-control input-lg" placeholder="" tabindex="1">
					</div>
				</div>
				<div class="col-xs-12 col-sm-6 col-md-6">
                    <h3>Aproximado de ingresos:</h3>
					<div class="form-group">
                        <input type="text" name="ingresos" id="ingresos" class="form-control input-lg" placeholder="0 Bsf" tabindex="1">
					</div>
				</div>                
            ...
            <div class="row">
				...
				<input type="email" name="email" id="email" class="form-control input-lg" placeholder="Correo" tabindex="4">
			     </div>
			...
			<div class="row">
				...
				<div class="col-xs-12 col-md-6"><a href="<?= base_url("index.php/clientes/register");?>" class="btn btn-warning btn-block btn-lg">Cancelar</a></div>
			</div>
		</form>
          </div>
        </div>
